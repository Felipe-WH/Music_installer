...
path = r""       # Path where your new music folder is gonna be     (E.g.: r"C:\Users\[your_pc_user]\Desktop)
directory = ""   # Name of the folder to allocate the musics        (E.g: "Downloaded musics"
